 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.rdsl.impl.InstallerImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstallerImpl extends MinimalEObjectImpl.Container implements Installer
{
  ...
  {
    return RdslPackage.Literals.INSTALLER;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RdslPackage.INSTALLER__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RdslPackage.INSTALLER__NAME:
        return getName();
    }
