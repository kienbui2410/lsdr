 ...
 *   <li>{@link org.xtext.rdsl.impl.InstanceImpl#getValnum <em>Valnum</em>}</li>
...
public class InstanceImpl extends MinimalEObjectImpl.Container implements Instance
{
   ...
   * @ordered
   */
  protected static final int VALNUM_EDEFAULT = 0;
   ...
   * @ordered
   */
  protected int valnum = VALNUM_EDEFAULT;
  ...
  public void setValnum(int newValnum)
  {
    ...
    valnum = newValnum;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RdslPackage.INSTANCE__VALNUM, oldValnum, valnum));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case RdslPackage.INSTANCE__VAL:
        return getVal();
      case RdslPackage.INSTANCE__VALNUM:
        return getValnum();
